...
// trailing slash.
const BASE_URL = args.baseUrl || 'https://codelabs.developers.google.com';
...
const PROD_BUCKET = gcs.bucketName(args.prodBucket || 'www.code-labs.io');

// STAGING_BUCKET is the default bucket for staging.
const STAGING_BUCKET = gcs.bucketName(args.stagingBucket || 'codelabs-staging');
