...
* Email us at codelab-submissions@google.com with a brief proposal of your content.
* Assuming your proposal is approved, draft your content using the tools and techniques documented in this repo. 
* When you're ready for a review, submit a link to your doc to codelab-submissions@google.com and we'll get it reviewed by one or more subject matter expert(s).
* Once reviewed and approved by Google, we'll copy the source doc, add attribution for the author, and publish it on our official site (g.co/codelabs).
